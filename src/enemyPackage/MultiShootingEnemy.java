...
public class MultiShootingEnemy extends BasicEnemy {
	...
	public MultiShootingEnemy(float x, float y, ImageLoader imageLoader, GameObjectController objectController, Player player) {
	...
	protected void setAnimation(ImageLoader imageLaoder) {
		animation = new Animation(imageLoader.getMultiShootingEnemyImages(), 12);
	}
	...
	protected void attack() {
		float ix = x+Bullet.SIZE/2;
		float iy = y+Bullet.SIZE/2;
