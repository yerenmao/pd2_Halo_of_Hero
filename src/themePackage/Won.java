...
public class Won {
	...
	public static final int menuBtnX = 400, menuBtnY = 420;
	public static final int restartBtnX = 560, restartBtnY = 420;
	
	public Won(ImageLoader imageLoader) {
		wonImage = imageLoader.getWonImage();
	...
	public void render(Graphics g) {
		...
		g.drawImage(wonImage, GameMain.WIDTH/4, 0, GameMain.WIDTH*3/4, GameMain.HEIGHT/2, 0, 0, wonImage.getWidth(), wonImage.getHeight(), null);
